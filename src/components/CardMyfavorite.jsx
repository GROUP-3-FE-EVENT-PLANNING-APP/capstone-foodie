    ...
    <div className="w-full lg:flex justify-center">
      ...
      <div className="w-full border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
        <div>
          ...
          <div hidden={!ishalal}>
            <div className="rounded-md flex justify-center box-border h-8 w-36 my-2 border-2 border-green-400">
          ...
          <div hidden={ishalal}>
            <div className="rounded-md flex justify-center box-border h-8 w-36 my-2 border-2 border-red-400">
          ...
          <button
            type="submit"
            className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-[#D9613C] hover:bg-[#ce542f] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#b85a3d]"
            onClick={onClick}
          >
            Remove
          </button>
