...
import { ThemeContext, RoleContext } from "../utils/context";
...
function Rot(props) {
  ...
  const profile = useMemo(() => ({ role, setRole }), [role]);
  ...
  return (
    <RoleContext.Provider value={profile}>
      <ThemeContext.Provider value={background}>
        <BrowserRouter>
          <Routes>
            ...
            <Route
              path="/admindetail/:admindetail_id"
              element={<DetailAdmin />}
            />
